      ...
      <div className="flex flex-col h-full justify-between space-y-6">
        <div className="flex items-start justify-between space-x-6">
          <div className="flex space-x-4">
            <div className="w-16 h-16 md:w-20 md:h-20 rounded-xl bg-gradient-to-b from-green-50 to-gray-50 flex items-center justify-center flex-shrink-0">
              <Tag className="w-8 h-8 md:w-10 md:h-10 text-green-600" />
            </div>
            
            <div className="flex flex-col space-y-3">
              <div className="flex items-center space-x-3">
                <h3 className="text-lg md:text-[1.6rem] font-bold text-gray-900">
